...
class CreateSpeciesRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'scientific_name' => 'required|max:200|unique:species,scientific_name',
            'common_name' => 'max:100',
            'kingdom' => 'max:80',
            'phylum' => 'max:100',
            'class' => 'max:100',
    ...
    public function messages(): array
    {
        return [
            ...
            'scientific_name.unique' => 'Xa existe unha especie con ese nome científico.',
            ...
            'images.required' => 'Debes subir polo menos unha imaxe.',
